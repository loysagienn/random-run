...
export const SvgLoading = ({ className, color, innerRef, onClick }: SvgProps) =>
  render({
...
export const SvgTimer = ({ className, color, innerRef, onClick }: SvgProps) =>
  render({
    className,
    color,
    innerRef,
...
export const SvgCross = ({ className, color, innerRef, onClick }: SvgProps) =>
  render({
    className,
    color,
    innerRef,
...
export const SvgMenu = ({ className, color, innerRef, onClick }: SvgProps) =>
  render({
    className,
    color,
    innerRef,
